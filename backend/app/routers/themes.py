        ...
        "themes": [
            {
                ...
                "rationale": "保有不動産の含み資産が株価に十分反映されていない銘柄群です。バランスシートに眠る土地・建物の価値に対して時価総額が小さく、資産の再評価や売却・再開発、アクティビストによる株主価値向上の動きが株価上昇のきっかけになりやすいことから注目されています。",
                "preset": "re-nav",
                "count": len(nav_items),
                "items": nav_items,
            },
            {
                ...
                "rationale": "手元資金が借入を上回り、財務が極めて健全な銘柄群です。下値不安が小さいうえ、潤沢な現金を使った自社株買い・増配といった株主還元や成長投資の余地が大きく、東証による資本効率改善の要請も追い風となるため注目されています。",
                "preset": "net-cash",
            ...
            },
            {
                ...
                "rationale": "配当利回りが高く、かつ営業キャッシュフローが黒字で配当の裏付けがある銘柄群です。インカム（配当収入）狙いの資金が集まりやすく、株価が下落する局面でも配当が下支えとなるため、金利環境が意識される中で注目されています。",
            ...
            },
            {
                ...
                "rationale": "直近四半期の売上が前年同期比で伸び、業績の勢いが加速している銘柄群です。決算を受けて業績上方修正や増額期待が高まりやすく、市場の関心が集まって短期の株価上昇につながりやすいことから注目されています。",
                "preset": "q-momentum",
                "count": len(q_items),
                "items": q_items,
            },
            {
                ...
                "rationale": "売上が成長しているにもかかわらずPERが低く、割安なまま放置されている銘柄群です。成長性と割安さを両立（GARP）しており、市場の評価が実力に追いつけば株価の見直し余地が大きいことから注目されています。",
                "preset": "value-growth",
            ...
            },
            {
                ...
                "rationale": "高いROEと利益率で稼ぐ力が強く、キャッシュフローも黒字の優良銘柄群です。資本効率が高く長期での複利的な成長が期待できるうえ、東証の資本効率改善要請の追い風も受けやすいことから注目されています。",
                "preset": "quality",
